/* QRCode for JavaScript, Copyright (c) 2009 Kazuhiko Arase, MIT License. Bundled locally for MiniStore; see THIRD_PARTY_NOTICES_QRCODE.txt. */
(function(g){"use strict";const modules={};modules["QR8bitByte"]=function(module,exports,require){
...
};const cache={};function require(id){if(cache[id])return cache[id].exports;if(!modules[id])throw new Error("Missing QR module "+id);const module={exports:{}};cache[id]=module;modules[id](module,module.exports,require);return module.exports;}g.MiniStoreQRCode=require("index");})(window);
